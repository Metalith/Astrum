...
void main()
{
    ...
    float lon = ((atan2(pos.x, pos.z) / 3.14) + 1.0) / 2.0; // Generates the Longitude via arcsin of up / radius. Divide by 3.14 to normalize to [-1,1] then add 1 / 2 to reduce range to [0..1]
